...
import requests  # Importar a biblioteca requests para enviar dados ao Google Forms
...
if total > 0:
    ...
    if submitted:
        ...
        def enviar_para_formulario_google(dados_pedido):
            form_id = '1rfNFpQaoklxxYL1Ug8RMlytGea7NBVmtRywlpyt2EpY'  # Substitua pelo ID do seu formulário
            url_formulario = f'https://docs.google.com/forms/d/e/{form_id}/formResponse'

            payload = {
                'entry.564129158': dados_pedido['Pedido ID'],
                'entry.794261772': dados_pedido['Data'],
                'entry.1220128973': dados_pedido['Nome'],
                'entry.963749064': dados_pedido['Email'],
                'entry.330903973': dados_pedido['Telefone'],
                'entry.225856675': str(dados_pedido['Preço Total']),
                'entry.1820386119': dados_pedido['Status'],
                'entry.748829019': dados_pedido['Observações'],
